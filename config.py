...
parser.add_argument('--algorithm', type=str, default="fedavg",
                    choices=["local", "fedavg", "fedsplit", "fedprox", "fedgen", "feddf", "fedcg", "fedcg_w", "vaefl"])
parser.add_argument('--dataset', type=str, default="fmnist",
                    choices=["fmnist", "digit", "office", "cifar", "domainnet"])
parser.add_argument('--model', type=str, default="lenet5", choices=["lenet5", "resnet18", "alexnet"])
...
if args.algorithm == "fedvae":
    args.name = args.algorithm + '_' + args.dataset + str(
        args.n_clients) + '_' + args.model + '_' + str(args.seed)
