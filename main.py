...
if args.algorithm == 'local':
    ...
    from clients.vaefl import Client
    from servers.vaefl import Server
...
def main():
    ...
    while True:
        ...
        elif args.algorithm == "vaefl":
            server.receive(["VAE_Decoder", "classifier"])
            server.global_train()
            server.send(["VAE_Decoder", "classifier"])
